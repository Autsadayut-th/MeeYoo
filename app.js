    ...
    <div className="min-h-screen relative pb-28 md:pb-8 pt-safe">
      ...
      <header className="sticky top-0 z-30 bg-slate-900/90 backdrop-blur-xl border-b border-white/10 px-4 py-3 shadow-md">
        <div className="max-w-4xl mx-auto flex items-center justify-between">
          ...
          {/* User Persona Switcher Toggle (User 1 / User 2) */}
      ...
      <main className="max-w-4xl mx-auto px-4 pt-4">
        ...
        {activeTab === 'dashboard' && (
          <div className="space-y-5">
            ...
            <div className="glass-card p-4 flex items-center justify-between bg-gradient-to-r from-indigo-950/60 via-purple-950/40 to-slate-900/60 border-indigo-500/30">
              ...
              <button 
                onClick={() => {
                  ...
                  alert(`คัดลอกรหัสเชิญ ${house.code} เรียบร้อย! ส่งให้อีกคนเพื่อใช้งานคลังร่วมกัน`);
                }}
            ...
            {/* Quick Stat Summary Cards Grid (Mobile 2 columns) */}
                ...
                {items.slice(0, 5).map(item => {
                  ...
                  return (
                    <div key={item.id} className="bg-slate-900/80 border border-white/10 rounded-xl p-3 flex items-center justify-between gap-2">
                      ...
                      {/* Stock Quantity & Quick "ใช้ 1" Button */}
        ...
        {/* ==========================================================================
           TAB 2: STOCK ITEMS MANAGEMENT (MOBILE CARDS)
           ========================================================================== */}
        {activeTab === 'stock' && (
                ...
                filteredItems.map(item => {
                  ...
                  return (
                    <div key={item.id} className="glass-card relative overflow-hidden p-4 space-y-3">
                      ...
                      {/* Stock Quantity Display & Stepper + / - & Quick "ใช้ 1" */}
        ...
        {/* ==========================================================================
           TAB 3: SHOPPING LIST (MOBILE VIEW)
           ========================================================================== */}
        {activeTab === 'shopping' && (
          <div className="space-y-4">
        ...
        {/* ==========================================================================
           TAB 5: MEMBERS & SETTINGS (COMBINED FOR MOBILE ACCESSIBILITY)
           ========================================================================== */}
        {(activeTab === 'members' || activeTab === 'settings') && (
          <div className="space-y-4">
            {/* House Invitation Box */}
      ...
      {/* ==========================================================================
         MOBILE FLOATING ACTION BUTTON (FAB) FOR ADDING ITEM
         ========================================================================== */}
      <button 
      ...
      {/* ==========================================================================
         MODAL: CREATE / EDIT ITEM FORM (MOBILE OPTIMIZED)
         ========================================================================== */}
      {showAddModal && (
