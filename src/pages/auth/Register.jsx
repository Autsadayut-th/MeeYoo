    ...
    <div className="min-h-screen flex items-center justify-center p-4">
      <div className="glass-card bg-white dark:bg-slate-900 border border-stone-200 dark:border-slate-800 p-6 w-full max-w-md shadow-lg space-y-5">
        <div className="text-center space-y-2">
          ...
          <h1 className="font-heading font-bold text-xl text-stone-900 dark:text-white">ลงทะเบียน</h1>
          <p className="text-xs text-stone-500 dark:text-slate-400">สร้างบัญชีผู้ใช้สำหรับแชร์คลังของใช้ในบ้าน</p>
        </div>
